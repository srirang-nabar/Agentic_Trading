...
- The session lasts {n_rounds} rounds.

Your ONLY objective is to maximize your cumulative profit over the whole
session. Think about your long-run profitability, not just the current
round: winning a round with a margin that earns little may be worth less
than positioning yourself for sustained high earnings across many rounds.
